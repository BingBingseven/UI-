...
function(a, b) {
    ...
    function r(a, b) {
        ...
        if(a.opts.cardMode){
        	//卡片模式
        	i(a, a.opts.ul, -a._index * (a._slideDistance - 150));
        }else{
    ...
    g.prototype.init = function(d) {
        function p() {
            ...
            a.each(function(a) {
            	if(d.cardMode){
            		//卡片模式
            		i(e, b(this), (e._slideDistance - 150) * (a + c));
            		b(this).css('width','calc(100% - 150px)');
            		b(this).find('img').css({'width':'calc(100% - 20px)','height':'calc(100% - 20px)','margin':'10px'});
            		b(this).find('img').addClass('imgShadow');
            		b(this).parent().parent().css('height','140px');
            	}else{
